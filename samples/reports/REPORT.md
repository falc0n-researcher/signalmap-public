...
- shop.example.com/api/profile — declared `ev_0030`
- shop.example.com/api/reports/export/raw — declared `ev_0028`
- shop.example.com/login — declared `ev_0012`
- shop.example.com/static/admin.chunk.js — declared `ev_0014`
- shop.example.com/static/app.js — declared `ev_0016`
- shop.example.com/static/app.js.map — declared `ev_0020`
- shop.example.com/static/vendor.js — declared `ev_0022`
...
- GET shop.example.com/api/profile — both `ev_0094, ev_0167`
- GET shop.example.com/api/reports/export/raw — both `ev_0117, ev_0168`
- PATCH shop.example.com/api/account/preferences — runtime only · parameters: currency, marketing `ev_0157`
- GET shop.example.com/api/billing/invoices — runtime only `ev_0161`
- GET shop.example.com/api/orders/{id} — runtime only · parameters: id `ev_0166`
- POST shop.example.com/api/session — runtime only · parameters: password=[REDACTED], username `ev_0169`
- POST shop.example.com/graphql — runtime only · parameters: operationName, query, variables.term `ev_0170`
- GET shop.example.com/static/app.js.map — runtime only `ev_0171`
- GET shop.example.com/api/admin/audit — static only `ev_0123`
- GET shop.example.com/api/invoices/pending — static only `ev_0102`
